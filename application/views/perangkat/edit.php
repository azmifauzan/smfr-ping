...
<?php echo form_open('perangkat/edit/'.$perangkat['id_perangkat'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		<label for="nama_perangkat" class="col-md-4 control-label">Nama Perangkat</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<textarea name="keterangan"><?php echo ($this->input->post('keterangan') ? $this->input->post('keterangan') : $perangkat['keterangan']); ?></textarea>
		</div>
	</div>
	<div class="form-group">
		<label for="ip_address" class="col-md-4 control-label">Latitude</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="ip_address" class="col-md-4 control-label">Longitude</label>
		<div class="col-md-8">
