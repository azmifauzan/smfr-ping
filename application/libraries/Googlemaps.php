 ...
 * koor center indo : 0.5387,116.4194
 */
...
class Googlemaps {
	...
	var $apiKey						= ' AIzaSyAgDPWJV288ncHwKu8Au8Pd2U78ZWh6JSc '; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= "-6.949259,108.619679";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	var $zoom						= 8;						// The default zoom level of the map. If set to "auto" will autozoom/center to fit in all visible markers. If "auto", also overrides the $center parameter
